...
namespace WBW\JQuery\QueryBuilderBundle\Tests\Twig\Extension;
 ...
 * @package WBW\JQuery\QueryBuilderBundle\Tests\Twig\Extension
 * @version 2.4.3
 * @final
 */
final class QueryBuilderTwigExtensionTest extends PHPUnit_Framework_TestCase {
    ...
    public function testQueryBuilderScriptFunction() {
        ...
        $this->assertEquals($res1, $obj->queryBuilderScriptFunction("query-builder", "js"), "The method queryBuilderScriptFunction() does not return the expected string");
