...
final class QueryBuilderTwigExtensionTest extends PHPUnit_Framework_TestCase {
    ...
    public function testGetFunctions() {
        ...
        $this->assertEquals([$obj, "queryBuilderChartFunction"], $obj->getFunctions()[0]->getCallable(), "The method getCallable() does not return the expected callable on item 0");
    ...
    public function testQueryBuilerScriptFunction() {
        ...
        $res1 = "<script src=\"/bundles/wbwjquery-querybuiler/js/query-builder.js\" type=\"text/javascript\"></script>";
